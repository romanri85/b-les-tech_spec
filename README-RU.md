...
# 4. Авто присваивание тегов интерьерным фото проектов.
...
9. Коллекция петель - #atomika, #eclipse, итд. Тег создается по названию модели петель: "#" + ${название модели
   петель}
10. Набор цвета фурнитуры - #фурнитура хром, №фурнитура бронза, #фурнитира золото. Фурнитуре с набором цвета "Другое" тег не присваивается. Хардкод.
