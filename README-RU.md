...
Данные страницы "Избранное" должны заносится в localStorage браузера, чтобы при перезагрузке страницы данные не терялись.
...
Страница имеет вид таблицы. По горизонтали после карточки товара идет блок с количеством единиц товара. Пользователь может 
...
На странице также должна быть кнопка отправить товары на почту с инпутом для ввода почты и кнопкой "Отправить". При клике
